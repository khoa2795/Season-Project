...
const seedDatabase = async () => {
    try {
        ...
        const collectionsPath = path.join(__dirname, "../../season_data/collections-normalized.json");
        const sunglassesPath = path.join(__dirname, "../../season_data/sunglasses-normalized.json");
        const eyeglassesPath = path.join(__dirname, "../../season_data/eyeglasses-normalized.json");
        ...
        if (mongoose.connection.db) {
            ...
            console.log("Completely dropped the database (all schemas and data cleared)");
        }
        else {
