...
const inputPath = path.resolve(__dirname, "../../season_data/All-Products.json");
const bigsizePath = path.resolve(__dirname, "../../season_data/big-size.json");
const outputPath = path.resolve(__dirname, "../../season_data/All-Products-Normalized.json");
const mediumSizePath = path.resolve(__dirname, "../../season_data/medium-size.json");
const smallSizePath = path.resolve(__dirname, "../../season_data/small-size.json");
const metalFramePath = path.resolve(__dirname, "../../season_data/metal.json");
const collectionsPath = path.resolve(__dirname, "../../season_data/normalized_collections.json");
...
normalizeNewData();
//# sourceMappingURL=normalizeScrapedProducts.js.map