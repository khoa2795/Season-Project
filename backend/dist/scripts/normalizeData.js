...
const productsPath = path.join(__dirname, "../../season_data/Products_Grouped (1).json");
const normalizedCollectionsPath = path.join(__dirname, "../../season_data/normalized_collections.json");
const normalizedProductsPath = path.join(__dirname, "../../season_data/normalized_products.json");
const normalizeData = () => {
    // 1. Read files
